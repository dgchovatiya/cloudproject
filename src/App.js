...
const uploadImageToS3 = async (imgSrc, pathPrefix,label) => {
  ...
  const params = {
    ...
    Key: `${pathPrefix}/${label}.${extension}`,
    Body: base64Data,
...
class App extends Component {
  ...
  upload = async (imageSrc) => {
    ...
    console.log("image name",imageKey)
  ...
  render() {
    return (
      <div >
        <div  style={Mystyle}>
        <h1 class="mb-3" style={{paddingLeft:"45%"}}>Team LLC</h1>
        <p style={{paddingLeft:"35%"}}> <b>L</b>imbani NiravKumar - <b>L</b>akhankiya Darshan -  <b>C</b>hovatiya Denishkumar</p>
      </div>
      <div style={{paddingLeft: 100   }}>
        <h2 class="mb-3" style={{marginTop: 100   }}>S3 path is - s3://{awsmobile.aws_user_files_s3_bucket}/{this.state.datasetName}/{this.state.label}/</h2>
        ...
        <Form >
          <Form.Group >
            ...
            <Form.Input label='Image Name' placeholder='Label' name='label' onChange={this.handleChange} onBlur={this.handleLabelBlur} />
          </Form.Group>
        </Form>
